...
<div class="main">
    ...
    <div class="masonry" id="grid">
        @foreach ($items as $item)
            <div class="g-card" data-cat="{{ $item->category }}"
                data-src="{{ $item->image_url }}"
                data-cap="{{ $item->caption }}">
                <img src="{{ $item->image_url }}" alt="{{ $item->alt_text }}">
                <div class="g-overlay">
                    <div class="ov-tag">{{ $item->category_label }}</div>
                    <div class="ov-cap">{{ $item->overlay_caption }}</div>
                </div>
                <div class="g-expand">⤢</div>
                <div class="g-caption-strip">
                    <span class="cap-text">{{ $item->strip_caption }}</span>
                    <span class="cap-tag">{{ $item->category_label }}</span>
                </div>
            </div>
        @endforeach
    </div>
