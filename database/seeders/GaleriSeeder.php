    ...
    public function run(): void
    {
        $items = [
            ...
            [
                ...
                'category'        => 'taman',
                'alt_text'        => 'Taman',
                'caption'         => 'Taman Bermain Anak-Anak di Pantai Liang',
                'overlay_caption' => 'Taman bermain',
                'strip_caption'   => 'Taman',
                'order'           => 9,
                'is_featured'     => false,
            ],
            [
                'image_path'      => 'g.jpeg',
                'category'        => 'taman',
                'alt_text'        => 'Taman Bermain',
                'caption'         => 'Anak-anak bermain di Taman Pantai Liang',
                'overlay_caption' => 'Anak-anak bermain',
                'strip_caption'   => 'Taman Bermain',
                'order'           => 10,
                'is_featured'     => false,
            ],
            [
